...
<template>
  <div class="menu" data-menu="true">
    <div class="menu-item" data-menu-item-offset="20px, 10px" data-menu-item-offset-rtl="-20px, 10px" data-menu-item-placement="bottom-end" data-menu-item-placement-rtl="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:click">
      ...
      <img alt="" class="size-9 rounded-full shrink-0" :src="user.profile_picture_url ? user.profile_picture_url : 'assets/media/avatars/blank.png'">
      </img>
      </div>
      <div class="menu-dropdown menu-default light:border-gray-300 w-screen max-w-[250px]">
      <div class="flex items-center justify-between px-5 py-1.5 gap-1.5">
        <div class="flex items-center gap-2">
        <img alt="" class="size-9 rounded-full" :src="user.profile_picture_url ? user.profile_picture_url : 'assets/media/avatars/blank.png'">
