...
<template>
    ...
    <div class="sidebar-header hidden lg:flex items-center relative justify-between px-3 lg:px-6 shrink-0"
        id="sidebar_header">
        <Link class="dark:hidden" href="/">
            <img class="default-logo min-h-[22px] max-w-none" src="/assets/images/logo_unu_lampung.png" />
            <img class="small-logo min-h-[22px] max-w-none" src="/assets/images/logo_unu_lampung.png" />
        </Link>
        <Link class="hidden dark:block" href="/">
            <img class="default-logo min-h-[22px] max-w-none" src="/assets/images/logo_unu_lampung.png" />
            <img class="small-logo min-h-[22px] max-w-none" src="/assets/images/logo_unu_lampung.png" />
        </Link>
        <button
